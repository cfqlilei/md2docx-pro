...
private:
  ...
  void setupConnections() {
    ...
    connect(m_batchConverter, &BatchConverter::conversionStarted, this,
            &CompleteTestMainWindow::onConversionStarted);
    connect(m_batchConverter, &BatchConverter::conversionFinished, this,
            &CompleteTestMainWindow::onConversionFinished);
...
#include "main_complete_test.moc"
